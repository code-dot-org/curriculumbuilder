...
class CodeMirrorTextarea(forms.Textarea):
    ...
    def render(self, name, value, attrs=None):
        ...
        output = [super(CodeMirrorTextarea, self).render(name, value, attrs),
                  ...
                  '   }\n'
                  '   var selection = cm.getSelection();\n'
                  '   if (!selection) selection = "Assessment Opportunity content here";\n'
                  '     cm.replaceSelection("\\nassessment!!!assessment-" + assessmentid + "<!-- place where you\'d like the icon -->" +\n'
                  ...
                  ' {\n'
                  ' class: "slide",\n'
                  ' label: \'<i class="fa fa-list-alt" aria-hidden="true"></i>\',\n'
                  ' callback: function (cm) {\n'
                  ...
                  '   }\n'
                  '   var selection = cm.getSelection();\n'
                  '   if (!selection) selection = "Slide content here";\n'
                  '     cm.replaceSelection("\\nslide!!!slide-" + slideid + "<!-- place where you\'d like the icon --> \\n");\n'
                  '     if (!selection) {\n'
                  '       var cursorPos = cm.getCursor();\n'
                  '       cm.setCursor(cursorPos.line, cursorPos.ch - 1);\n'
                  '     }\n'
                  ...
                  '  allowedTypes: [ "image/jpeg", "image/png", "image/jpg", "image/gif", "image/svg+xml", "application/pdf"],\n'
