...
(function () {
    ...
    Annotator.Plugin.MarginAnnotator = (function (_super) {
        __extends(MarginAnnotator, _super);

        MarginAnnotator.prototype.events = {
        ...
        MarginAnnotator.prototype.field = null;

        MarginAnnotator.prototype.input = null;

        MarginAnnotator.prototype.options = {
            MarginAnnotator: {}
        };


        function MarginAnnotator(element, options) {
            ...
            MarginAnnotator.__super__.constructor.apply(this, arguments);
        ...
        MarginAnnotator.prototype.pluginInit = function () {
         ...
         */
        MarginAnnotator.prototype.onFilter = function (event) {
        ...
        MarginAnnotator.prototype.onDeleteClick = function (event) {
            event.stopPropagation();
            return this.onButtonClick(event, 'delete');
        };

        MarginAnnotator.prototype.onEditClick = function (event) {
            event.stopPropagation();
            return this.onButtonClick(event, 'edit');
        };

        MarginAnnotator.prototype.onButtonClick = function (event, type) {
            var item;
        ...
        MarginAnnotator.prototype.textareaEditor = function (annotator_textArea, item) {
        ...
        MarginAnnotator.prototype.tinymceActivation = function (selector) {
            tinymce.init({
                selector: selector,
        ...
        MarginAnnotator.prototype.onSavePanel = function (event) {
        ...
        //Event triggered when save the content of the annotation
        MarginAnnotator.prototype.onCancelPanel = function (event) {
            var current_annotation = event.data.annotation;
        ...
        MarginAnnotator.prototype.normalEditor = function (annotation, editableTextArea) {
        ...
        MarginAnnotator.prototype.onAnnotationCreated = function (annotation) {
        ...
        MarginAnnotator.prototype.onAnnotationUpdated = function (annotation) {

            $("#annotation-" + annotation.id).html(this.mascaraAnnotation(annotation));
        };

        MarginAnnotator.prototype.onAnnotationsLoaded = function (annotations) {
            var annotation;
            $('#count-anotations').text($(".container-anotacions").find('.annotator-marginviewer-element').length);
        ...
        MarginAnnotator.prototype.onAnnotationDeleted = function (annotation) {
        ...
        MarginAnnotator.prototype.mascaraAnnotation = function (annotation) {

            var shared_annotation = "";
            var class_label = "label";
            var delete_icon = "<span>delete</span>";
            var textAnnotation = annotation.text;
            var annotation_layer = '<div class="annotator-marginviewer-text"><div class="anotator_color_box"></div>';
        ...
        MarginAnnotator.prototype.createAnnotationPanel = function (annotation) {
            ...
            var annotation_layer = '<div  class="annotations-list-uoc" style="background-color:#ddd;"><div id="annotations-panel"><span class="rotate" style="padding:5px;background-color:#ddd;position: absolute; top:10em;left: -50px; width: 155px; height: 110px;cursor:pointer">' + view_annotations + '<span class="label-counter" style="padding:0.2em 0.3em;float:right" id="count-anotations">0</span></span></div><div id="anotacions-uoc-panel" style="height:80%"><ul class="container-anotacions"><li class="filter-panel">' + checboxes + '</li></ul></div></div>';

            return annotation_layer;
        };


        MarginAnnotator.prototype.createReferenceAnnotation = function (annotation) {
        ...
        MarginAnnotator.prototype.uniqId = function () {
            return Math.round(new Date().getTime() + (Math.random() * 100));
        }

        //Strip content tags
        MarginAnnotator.prototype.removeTags = function (striptags, html) {
