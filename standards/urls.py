...
urlpatterns = patterns('standards.views',
                       ...
                       url(r'^framework/(?P<slug>[-\w]+)_standards.csv$', views.standards_by_framework_csv, name='standards_by_framework_csv'),
                       url(r'^framework/(?P<slug>[-\w]+)_categories.csv$', views.categories_by_framework_csv, name='categories_by_framework_csv'),
