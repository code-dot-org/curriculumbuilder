...
urlpatterns += patterns('',
                        ...
                        url(r'^api/v1/curriculum/(?P<curriculum_slug>[-\w]+)/standards/$', standard_list,
                            name="standard_list"),
                        # url(r'^api/v1/curriculum/(?P<curriculum_slug>[-\w]+)/standards/(?P<framework_slug>[-\w]+)/$', standard_list, name="standard_list"),
                        url(r'^api/v1/curriculum/(?P<curriculum_slug>[-\w]+)/standards/(?P<framework_slug>[-\w]+)/$',
                            nested_category_list, name="nested_category_list"),
                        url(
                            r'^api/v1/curriculum/(?P<curriculum_slug>[-\w]+)/standards/(?P<framework_slug>[-\w]+)/standards/$',
                            nested_standard_list, name="nested_standard_list"),
                        url(r'^api/v1/curriculum/(?P<slug>[-\w]+)/$', views.curriculum_element,
                            name="curriculum_element"),
                        url(r'^api/v1/curriculum/(?P<slug>[-\w]+)/units/$', views.unit_list, name="unit_list"),
                        url(r'^api/v1/curriculum/(?P<slug>[-\w]+)/(?P<unit_slug>[-\w]+)/$', views.unit_element,
                            name="unit_element"),
                        url(r'^api/v1/curriculum/(?P<slug>[-\w]+)/(?P<unit_slug>[-\w]+)/(?P<lesson_num>\d+)/$',
                            views.lesson_element, name="lesson_element"),
