...
urlpatterns = patterns('curricula.views',
                        ...
                        url(r'^(?P<slug>[0-9a-zA-Z]+)/(?P<unit_slug>[0-9a-zA-Z]+)/code/$', views.unit_code, name='unit_code'),
                        url(r'^(?P<slug>[0-9a-zA-Z]+)/(?P<unit_slug>[0-9a-zA-Z]+)/vocab/$', views.unit_vocab, name='unit_vocab'),
