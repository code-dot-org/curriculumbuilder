...
urlpatterns = patterns('curricula.views',
                       ...
                       url(r'^(?P<slug>[0-9a-zA-Z]+)/resources/$', views.curriculum_resources,
                           name='curriculum_resources'),
                       url(r'^(?P<slug>[0-9a-zA-Z]+)/standards/$', standards_views.by_curriculum, name='by_curriculum'),
                       url(r'^(?P<slug>[0-9a-zA-Z]+)/standards/(?P<unit_slug>[a-zA-Z]+)/$', standards_views.by_unit,
                           name='by_unit'),
                       url(r'^(?P<slug>[0-9a-zA-Z]+)/(?P<unit_slug>[0-9a-zA-Z]+)/$', views.unit_view, name='unit_view'),
                       url(r'^(?P<slug>[0-9a-zA-Z]+)/(?P<unit_slug>[0-9a-zA-Z]+).pdf$', views.unit_pdf,
                           name='unit_pdf'),
                       ...
                       url(r'^(?P<slug>[0-9a-zA-Z]+)/(?P<unit_slug>[0-9a-zA-Z]+)/standards/$', standards_views.by_unit,
                           name='by_unit_2'),
